package com.luisbar.waterdelivery.presentation.view.adapter.util;
...
public class NumberToWordsConverter {
    ...
    private static String convertNumber(String number) {
        ...
        if (k <= 20)
            ...
            output.append(DECENAS[getDigitAt(number, 1) - 2].toLowerCase())
                    .append("y ")
                    .append(UNIDADES[getDigitAt(number, 0)].toLowerCase());
        else
            output.append(DECENAS[getDigitAt(number, 1) - 2].toLowerCase())
                    .append(UNIDADES[getDigitAt(number, 0)].toLowerCase());
